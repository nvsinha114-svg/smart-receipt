...
import { FileText, LayoutDashboard, LogOut, PlusCircle, UserRound, ScanLine } from "lucide-react";
    ...
    <div className="app-shell">
      <aside className="sidebar">
        <div className="brand">
          ...
          <div><strong>Smart Receipt</strong><span>Receipt Scanner</span></div>
        </div>
        <nav>
          <NavLink to="/dashboard"><LayoutDashboard size={18}/> Dashboard</NavLink>
          <NavLink to="/upload"><PlusCircle size={18}/> Scan Receipt</NavLink>
