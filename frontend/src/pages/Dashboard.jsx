...
export default function Dashboard(){
  const [receipts,setReceipts]=useState([]),[medReports,setMedReports]=useState([]),[loading,setLoading]=useState(true);
  useEffect(()=>{
    Promise.all([
  ...
  return <div className="page"><header className="topbar"><div><span className="eyebrow">Overview</span><h1>Dashboard</h1></div><Link className="primary-btn" to="/upload"><PlusCircle size={18}/> Scan Document</Link></header>
    <div className="stats">
